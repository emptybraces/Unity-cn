...
public static class cn
{
    ...
    [Conditional("DEBUG")] public static void logColored(DummyArg _ = null, [CallerFilePath] string path = "", [CallerLineNumber] int line = 0) => _LogFormattedLine(LogType.Log, _MakeColorCode((uint)line), path, line);
