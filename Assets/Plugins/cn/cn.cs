...
public static class cn
{
	...
	[Conditional("DEBUG")] public static void logColored(DummyArg _ = null, [CallerFilePath] string path = "", [CallerLineNumber] int line = 0) => _LogFormattedLine(LogType.Log, _MakeColorCode(line), path, line);
	[Conditional("DEBUG")] public static void logColored<T1>(T1 t1, DummyArg _ = null) => _LogFormattedT<T1>(LogType.Log, _MakeColorCode(t1?.ToString()), t1, "", "");
	[Conditional("DEBUG")] public static void logColored<T1, T2>(T1 t1, T2 t2, DummyArg _ = null) => _LogFormattedT<T1, T2>(LogType.Log, _MakeColorCode(t1?.ToString()), t1, t2, "", "");
	[Conditional("DEBUG")] public static void logColored<T1, T2, T3>(T1 t1, T2 t2, T3 t3, DummyArg _ = null) => _LogFormattedT(LogType.Log, _MakeColorCode(t1?.ToString()), t1, t2, t3, "", "");
	[Conditional("DEBUG")] public static void logColored<T1, T2, T3, T4>(T1 t1, T2 t2, T3 t3, T4 t4, DummyArg _ = null) => _LogFormattedT(LogType.Log, _MakeColorCode(t1?.ToString()), t1, t2, t3, t4, "", "");
	[Conditional("DEBUG")] public static void logColored<T1, T2, T3, T4, T5>(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, DummyArg _ = null) => _LogFormattedT(LogType.Log, _MakeColorCode(t1?.ToString()), t1, t2, t3, t4, t5, "", "");
	[Conditional("DEBUG")] public static void logColored<T1, T2, T3, T4, T5, T6>(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, DummyArg _ = null) => _LogFormattedT(LogType.Log, _MakeColorCode(t1?.ToString()), t1, t2, t3, t4, t5, t6, "", "");
	[Conditional("DEBUG")] public static void logColored<T1, T2, T3, T4, T5, T6, T7>(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, DummyArg _ = null) => _LogFormattedT(LogType.Log, _MakeColorCode(t1?.ToString()), t1, t2, t3, t4, t5, t6, t7, "", "");
	[Conditional("DEBUG")] public static void logColored<T1, T2, T3, T4, T5, T6, T7, T8>(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, DummyArg _ = null) => _LogFormattedT(LogType.Log, _MakeColorCode(t1?.ToString()), t1, t2, t3, t4, t5, t6, t7, t8, "", "");
	[Conditional("DEBUG")] public static void logColoredf(DummyArg _ = null, [CallerFilePath] string path = "", [CallerMemberName] string member = "") => _LogFormatted(LogType.Log, _MakeColorCode(path), path, member);
	[Conditional("DEBUG")] public static void logColoredf<T1>(T1 t1, DummyArg _ = null, [CallerFilePath] string path = "", [CallerMemberName] string member = "") => _LogFormattedT<T1>(LogType.Log, _MakeColorCode(path), t1, path, member);
	[Conditional("DEBUG")] public static void logColoredf<T1, T2>(T1 t1, T2 t2, DummyArg _ = null, [CallerFilePath] string path = "", [CallerMemberName] string member = "") => _LogFormattedT<T1, T2>(LogType.Log, _MakeColorCode(path), t1, t2, path, member);
	[Conditional("DEBUG")] public static void logColoredf<T1, T2, T3>(T1 t1, T2 t2, T3 t3, DummyArg _ = null, [CallerFilePath] string path = "", [CallerMemberName] string member = "") => _LogFormattedT(LogType.Log, _MakeColorCode(path), t1, t2, t3, path, member);
	[Conditional("DEBUG")] public static void logColoredf<T1, T2, T3, T4>(T1 t1, T2 t2, T3 t3, T4 t4, DummyArg _ = null, [CallerFilePath] string path = "", [CallerMemberName] string member = "") => _LogFormattedT(LogType.Log, _MakeColorCode(path), t1, t2, t3, t4, path, member);
	[Conditional("DEBUG")] public static void logColoredf<T1, T2, T3, T4, T5>(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, DummyArg _ = null, [CallerFilePath] string path = "", [CallerMemberName] string member = "") => _LogFormattedT(LogType.Log, _MakeColorCode(path), t1, t2, t3, t4, t5, path, member);
	[Conditional("DEBUG")] public static void logColoredf<T1, T2, T3, T4, T5, T6>(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, DummyArg _ = null, [CallerFilePath] string path = "", [CallerMemberName] string member = "") => _LogFormattedT(LogType.Log, _MakeColorCode(path), t1, t2, t3, t4, t5, t6, path, member);
	[Conditional("DEBUG")] public static void logColoredf<T1, T2, T3, T4, T5, T6, T7>(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, DummyArg _ = null, [CallerFilePath] string path = "", [CallerMemberName] string member = "") => _LogFormattedT(LogType.Log, _MakeColorCode(path), t1, t2, t3, t4, t5, t6, t7, path, member);
	[Conditional("DEBUG")] public static void logColoredf<T1, T2, T3, T4, T5, T6, T7, T8>(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, DummyArg _ = null, [CallerFilePath] string path = "", [CallerMemberName] string member = "") => _LogFormattedT(LogType.Log, _MakeColorCode(path), t1, t2, t3, t4, t5, t6, t7, t8, path, member);
	...
	static string _MakeColorCode(string s)
	{
		...
		for (int i = 0; i < s.Length; ++i)
			n += (byte)s[i];
		return _MakeColorCode(n);
	}
	static string _MakeColorCode(int n)
	{
		return ColorUtility.ToHtmlStringRGB(Color.HSVToRGB(n / 255f % 1f, 0.5f, 1f));
	}
